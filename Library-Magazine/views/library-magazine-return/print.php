            ...
            <table width="100%" cellpadding="5" id="table">
                <thead>
                    <tr>
                        ...
                        <th class="th" rowspan="2">Magazine Name</th>
                        <th class="th" rowspan="2">Member Name</th>
                        <th class="th" rowspan="2">Return Date</th>
                        <th class="th" rowspan="2">Issue Date</th>
                        <th class="th" rowspan="2">Due Date</th>
...
//                    exit;
                    ...
                    <tr>
                        <td><?php echo $i++; ?></td>
                            ...
                            <td style="text-align: left;"><?php echo date("d/m/Y",strtotime($key['Magazine_Return_Date'])); ?></td>
                            <td style="text-align: left;"><?php echo date("d/m/Y",strtotime($key['Magazine_Issue_Date'])); ?></td>
                            <td style="text-align: left;"><?php echo date("d/m/Y",strtotime($key['Magazine_Due_Date'])); ?></td>
                            <td style="text-align: left;"><?php echo $key['Remarks']; ?></td>
                    </tr>
                    <?php
                }
                ?>
