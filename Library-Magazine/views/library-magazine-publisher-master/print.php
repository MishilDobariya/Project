...
//                    exit;
                    ...
                    <tr>
                        <td><?php echo $i++; ?></td>
                            ...
                            <td style="text-align: left;"><?php echo $key['Magazine_Publisher_Address']; ?></td>
                            <td style="text-align: left;"><?php echo $key['Magazine_Publisher_Phone_No']; ?></td>
                            <td style="text-align: left;"><?php echo $key['Magazine_Publisher_Fax_No']; ?></td>
                            <td style="text-align: left;"><?php echo $key['Magazine_Publisher_Mobile_No']; ?></td>
                            <td style="text-align: left;"><?php echo $key['Magazine_Publisher_Email_Address']; ?></td>
                            <td style="text-align: left;"><?php echo $key['Magazine_Publisher_Web_Address']; ?></td>
                            <td style="text-align: left;"><?php echo $key['Magazine_Publisher_Contact_Person_Name']; ?></td>
                    </tr>
                    <?php
                }
                ?>
