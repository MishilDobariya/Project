    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">     
                <div class="row">
                    <div class="col-lg-11" >
                        <h2 class="title-1 m-b-25 text-center" >History</h2>
                        <div class="table-responsive table--no-card m-b-40 row d-flex justify-content-center" style="margin-left: -10px; width:1000px">
								...
								<?php
									if(isset($_POST['submitt'])){
										if(isset($_POST['search'])){
											$select = mysqli_query($link,"select * from history where Name like '%".$_POST['search']."%' or Post like '%".$_POST['search']."%'");
										}
										else{
											$select = mysqli_query($link,"select * from history");
										}
									}
									else{
										$select = mysqli_query($link,"select * from history");
